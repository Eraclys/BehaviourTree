...
namespace BehaviourTree.Tests
{
    ...
    internal sealed class InverterTests
    {
        ...
        {
            var sut = new Inverter(new MockBehaviour {ReturnStatus = BehaviourStatus.Succeeded});
        ...
        {
            var sut = new Inverter(new MockBehaviour { ReturnStatus = BehaviourStatus.Failed });
        ...
        {
            var sut = new Inverter(new MockBehaviour { ReturnStatus = BehaviourStatus.Running });
